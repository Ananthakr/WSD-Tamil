...
isWhat = 0		# 0 - ROOT, 1 - NOUN, 2 - VERB
SetPrefix = 0		# 0 - No, 1 - Yes
SetSuffix = 0		# 0 - No, 1 - Yes
...
nounSuffix = [u'ஐ',u'க்அள்',u'உக்க்உ',u'க்க்உ',u'ஆக்அ',u'ஆல்',u'அல்',u'ஒட்உ',u'உட்அன்',u'உடை',u'இல்',u'கண்',u'இட்அம்',u'இர்உந்த்உ',u'இன்',u'அத்உ']
	...
	# ABL	- Ablative
	# GEN	- Genitive
	# VP	- Verb or Verb Phrase
	# NP	- Noun or Noun Phrase
	...
	# 3SMF	- Third Person Singular Masculine Feminine
	# 3SN	- Third Person Singular Neuter
	# 3PLN	- Third Person Plural Neuter
	# 3PLMF - Third Person Plural Masculine Feminine
...
def processStem(string):
	stemmerPath = "/home/ananth/tamil-stemmer-build/snowball-with-tamil/stemwords"
...
s=''
while s!=' ':
    s = raw_input("\n Enter the Tamil word : ")
    print '%s => ' % (s.decode('utf-8'))
    for word in s.split():
        m = tamilMorphologicalAnalyzer(word)
        #print ' %s ' % (m)
